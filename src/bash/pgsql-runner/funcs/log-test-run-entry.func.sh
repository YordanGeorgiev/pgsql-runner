# src/bash/pgsql-runner/funcs/log-test-run-entry.func.sh
...
doLogTestRunEntry(){
   ...
   case "$1" in
     INIT)
         # cat doc/txt/pgsql-runner/funcs/log-test-run-entry.func.txt
...
# eof file: src/bash/pgsql-runner/funcs/log-test-run-entry.func.sh
