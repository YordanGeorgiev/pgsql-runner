# src/bash/pgsql-runner/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat doc/txt/pgsql-runner/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: src/bash/pgsql-runner/funcs/create-relative-7z-package.spec.sh
