...
doTestCreateRelativePackage(){
   ...
   bash src/bash/pgsql-runner/pgsql-runner.sh -a create-relative-package -i met/.tst.pgsql-runner
   export exit_code=$?
   ...
   test $exit_code -ne 0 && return
	...
	bash src/bash/pgsql-runner/pgsql-runner.sh -a create-relative-package -i met/.prd.pgsql-runner
   export exit_code=$?
   ...
   # test the call with the include file of the prd env
   bash src/bash/pgsql-runner/pgsql-runner.sh -a create-relative-package -i met/.git.pgsql-runner
   export exit_code=$?
