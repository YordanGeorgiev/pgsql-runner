# src/bash/pgsql-runner/funcs/log-test-run-entry.test.sh
...
doTestLogTestRunEntry(){
	...
	cat doc/txt/pgsql-runner/tests/log-test-run-entry.test.txt
...
# eof file: src/bash/pgsql-runner/funcs/log-test-run-entry.test.sh
